...
export type IButtonComponentType<ButtonProps, GroupProps, GroupHSpacerProps, GroupVSpacerProps, SpinnerProps, TextProps> = ((props: ButtonProps & IButtonProps) => JSX.Element) & {
    Group: React.MemoExoticComponent<(props: GroupProps & IButtonGroupProps) => JSX.Element>;
    GroupHSpacerProps: React.MemoExoticComponent<(props: GroupHSpacerProps) => JSX.Element>;
    GroupVSpacerProps: React.MemoExoticComponent<(props: GroupVSpacerProps) => JSX.Element>;
