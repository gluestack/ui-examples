...
>(
  ...
  Select.DragIndicator = DragIndicator;
  Select.DragIndicatorWrapper = DragIndicatorWrapper;
  Select.Item = Item;
  Select.ScrollView = ScrollView;
  Select.VirtualizedList = VirtualizedList;
  Select.FlatList = FlatList;
  Select.SectionList = SectionList;
  Select.SectionHeaderText = SectionHeaderText;
