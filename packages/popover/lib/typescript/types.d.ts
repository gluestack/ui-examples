...
export type IPopoverComponentType<PopoverProps, ArrowProps, ContentProps, HeaderProps, FooterProps, BodyProps, BackdropProps, CloseButtonProps> = ((props: IPopoverProps & PopoverProps) => JSX.Element) & {
