...
export type IMenuComponentType<Root, Item, Label> = ((props: Root & IMenuProps) => JSX.Element) & {
    Item: React.MemoExoticComponent<(props: Item & ItemProps<Item> & IItemProp) => JSX.Element>;
