...
export type IToastComponentType<StyledToast, StyledToastTitle, StyledToastDescription> = ((props: StyledToast) => JSX.Element) & {
    Title: React.MemoExoticComponent<(props: StyledToastTitle) => JSX.Element>;
    Description: React.MemoExoticComponent<(props: StyledToastDescription) => JSX.Element>;
};
