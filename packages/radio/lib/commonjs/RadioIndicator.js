...
const RadioIndicator = StyledRadioIndicator => /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  let {
    children,
    ...props
  } = _ref;
  ...
  return /*#__PURE__*/_react.default.createElement(StyledRadioIndicator, _extends({
    states: {
      checked: isChecked,
      disabled: isDisabled,
