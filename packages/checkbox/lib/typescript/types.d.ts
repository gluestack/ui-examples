...
export type ICheckboxComponentType<Root, Indicator, Icon, Label, Group> = ((props: Root & InterfaceCheckbox) => JSX.Element) & {
    ...
    Group: React.MemoExoticComponent<(props: Group & CheckboxGroup) => JSX.Element>;
};
