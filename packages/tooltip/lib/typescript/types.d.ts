...
export type IToolTipComponentType<StyledTooltip, StyledTooltipContent> = ((props: StyledTooltip & ITooltipProps) => JSX.Element) & {
    Content: React.MemoExoticComponent<(props: StyledTooltipContent) => JSX.Element>;
};
